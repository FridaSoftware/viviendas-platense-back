...
const putGeneralDataHandler = async (req, res) => {
    ...
    const { _id, state, saleDate, handoverDate, other, contractSigned } = req.body;
    ...
    try {
        ...
        const updatedClient = await putController(_id, state, saleDate, handoverDate, other, contractSigned);
